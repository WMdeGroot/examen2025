...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private Collection $studentlesson;

    /**
     * @var Collection<int, Lesson>
     */
    #[ORM\OneToMany(targetEntity: Lesson::class, mappedBy: 'instructor')]
    private Collection $instructor;

    public function __construct()
    {
        $this->lessons = new ArrayCollection();
        $this->studentlesson = new ArrayCollection();
     ...
     */
    public function getStudentlesson(): Collection
    {
    ...
    {
        if (!$this->studentlesson->contains($studentlesson)) {
            $this->studentlesson->add($studentlesson);
    ...
    {
        if ($this->studentlesson->removeElement($studentlesson)) {
