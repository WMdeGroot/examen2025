 ...
 */
final class Version20250522142316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE lesson DROP users_id, DROP instructor
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE lesson ADD users_id INT NOT NULL, ADD instructor VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
